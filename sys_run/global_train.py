...
def train_model(args, gpu_id, train_inputs, train_inputs_shape, train_labels, train_labels_shape, \
                val_inputs, val_inputs_shape, val_labels, val_labels_shape, model_id, models, model_dir, experiment_logger):
  print(f"training {len(models)} models on GPU {gpu_id}")
  print(f"id of train inputs {id(train_inputs)}")
  train_queue = create_train_dataset(args, train_inputs, train_inputs_shape, train_labels, train_labels_shape)
  valid_queue = create_validation_dataset(args, val_inputs, val_inputs_shape, val_labels, val_labels_shape)
