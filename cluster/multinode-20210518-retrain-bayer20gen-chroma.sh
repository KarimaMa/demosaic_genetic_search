...
RETRAIN_DATA=$ROOT/retrain_data/chroma-pareto-models/bayer20gen-chroma-05-16
RETRAIN_LIST=$RETRAIN_DATA/model_ids.txt
RETRAIN_LOGS=$ROOT/retrain_logs/bayer20gen-chroma-05-16
...
python $CODE_LOCAL/multinode_sys_run/retrain_one_model.py \
    ...
    --save=$ROOT/results/RETRAINED-BAYER20GEN-CHROMA-05-16 \
