...
RETRAIN_DATA=$ROOT/retrain_data/RGB8CHAN_MODEL_SEARCH_01-15
RETRAIN_LIST=$RETRAIN_DATA/pareto_model_ids.txt
RETRAIN_LOGS=$ROOT/retrain_logs/RGB8CHAN_MODEL_SEARCH_01-15
...
python $CODE_LOCAL/sys_run/retrain_one_model.py \
	...
	--save=$ROOT/results/RETRAINED_RGB8CHAN_MODEL_SEARCH_01-15 \
