...
python $CODE_LOCAL/sys_run/run-using-queue.py \
    ...
    --save=$ROOT/results/BAYER-GREEN-05-07-SEARCH-RUN1 \
    ...
    --pixel_width=128 \
    --crop=16 \
    --restart_generation=34 \
    --restart_tier=0 \
    --model_db_snapshot=$ROOT/results/BAYER-GREEN-05-07-SEARCH-RUN1/model_database/ModelDatabase-snapshot-20210511-035537 \
    --tier_db_snapshot=$ROOT/results/BAYER-GREEN-05-07-SEARCH-RUN1/cost_tier_database/TierDatabase-snapshot-20210511-035537
