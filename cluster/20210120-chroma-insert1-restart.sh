...
python $CODE_LOCAL/sys_run/run.py \
    ...
    --save=$ROOT/results/CHROMA_MODEL_SEARCH_01-20-INSERT \
    ...
    --restart_gen=9 \
    --restart_tier=0 \
    --tier_db_snapshot=$ROOT/results/CHROMA_MODEL_SEARCH_01-20-INSERT/cost_tier_database/TierDatabase-snapshot-20210121-045908 \
    --model_db_snapshot=$ROOT/results/CHROMA_MODEL_SEARCH_01-20-INSERT/model_database/ModelDatabase-snapshot-20210121-045908 \
