...
python $CODE_LOCAL/multinode_sys_run/manager.py \
    ...
    --save=$ROOT/results/MULTINODE-SR-ONLY-05-$DATE-RUN$RUN \
    ...
    --tier_size=20 \
    --sr_seed_model_files=superres-seed-model-files/sr_only_seed_asts.txt \
    --sr_seed_model_psnrs=superres-seed-model-files/sr_only_seed_psnrs.txt \
    --insertion_bias \
    --late_cdf_gen=9 \
    --max_footprint=30 \
