...
RETRAIN_DATA=$ROOT/retrain_data/CHROMA_MODEL_SEARCH_01-20-INSERT
RETRAIN_LIST=$RETRAIN_DATA/pareto_model_ids.txt
RETRAIN_LOGS=$ROOT/retrain_logs/CHROMA_MODEL_SEARCH_01-20-INSERT
...
python $CODE_LOCAL/sys_run/retrain_one_model.py \
    ...
    --save=$ROOT/results/RETRAINED-CHROMA20GEN-INSERT \
