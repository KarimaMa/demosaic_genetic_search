...
def train(args, models, model_id, model_dir):
  ...
  train_data = RedDataset(data_file=args.training_file,
                    green_input=args.use_green_input, 
                    green_pred_input=args.use_green_pred,
                    green_file=args.green_training_file,
                    redgb=args.gb_model, redgr=args.gr_model, redb=args.b_model)
...
if __name__ == "__main__":
  ...
  parser.add_argument('--b_model', action='store_true')
  ...
  if args.gr_model:
    model = model_lib.red_gr_simple_model()
  elif args.gb_model:
    model = model_lib.red_gb_simple_model()
  elif args.b_model:
    model = model_lib.red_b_simple_model()
  else:
    assert False, "no red model specified"
