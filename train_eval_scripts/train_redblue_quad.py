...
from dataset import RedBlueQuadDataset, FastDataLoader
...
def train(args, models, model_id, model_dir):
  ...
  train_data = RedBlueQuadDataset(data_file=args.training_file,
                    green_input=args.use_green_input, 
                    green_pred_input=args.use_green_pred,
                    green_file=args.green_training_file)

  validation_data = RedBlueQuadDataset(data_file=args.validation_file, 
                          green_input=args.use_green_input, 
                          green_pred_input=args.use_green_pred,
...
if __name__ == "__main__":
  ...
  model = model_lib.redblue_quad_diff_model() 
